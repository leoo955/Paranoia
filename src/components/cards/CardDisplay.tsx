  ...
  return (
    <div className={`relative ${wrapperClass} aspect-[2.5/3.5] mx-auto ${isEditing ? '' : 'perspective-1000'}`}>
      ...
      {isPremiumLayout ? (
        ...
        <div className="absolute top-4 left-4 right-4 bottom-1/2 rounded-t-lg border border-white/20 overflow-hidden pointer-events-none bg-black/10 backdrop-blur-[2px]" style={{ transform: 'translateZ(20px)' }}>
